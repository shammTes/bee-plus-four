...
class ContentRepository {
  ...
  Future<MatricBundle> matricBundle() async {
    ...
    const packs = [
      ...
      'matric_biology_2018.json',
      'matric_biology_2018_a.json',
      'matric_biology_2018_b.json',
      'matric_biology_2018_p1.json',
      'matric_biology_2018_p2.json',
      'matric_biology_2018_p3.json',
      'matric_biology_2023.json',
      'matric_chemistry.json',
      'matric_chemistry_2000.json',
      'matric_chemistry_2001.json',
      'matric_chemistry_2002.json',
      'matric_chemistry_2018.json',
      'matric_chemistry_2018_p1.json',
      'matric_chemistry_2018_p2.json',
      'matric_chemistry_2018_p3.json',
      'matric_chemistry_2023.json',
      'matric_chemistry_2023_a.json',
      'matric_chemistry_2023_b.json',
      'matric_chemistry_2023_p1.json',
      'matric_chemistry_2023_p2.json',
      'matric_chemistry_2023_p3.json',
      'matric_math.json',
      ...
      'matric_physics_2018.json',
      'matric_physics_2018_a.json',
      'matric_physics_2018_b.json',
      'matric_english.json',
