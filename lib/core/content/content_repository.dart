...
/// Loads curriculum JSON from assets. Fail-soft + session cache.
    ...
    try {
      ...
      _slides = map.map((k, v) {
        final list = (v as List)
            .map((e) => IllustratedSlide.fromJson(e as Map<String, dynamic>))
            .toList();
